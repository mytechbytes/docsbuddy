...
// file is absent (local debug builds, or CI without secrets) the release build
// falls back to the debug keystore so it still compiles — but that fallback is
// NOT acceptable for a Play Store upload.
